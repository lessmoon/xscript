...
import vm.detail.JumpIfNotOperator;
...
public class While extends Stmt {
    ...
    public void compile(Compiler compiler) {
        ...
        compiler.getContinuePosition().setValue(begin).finished();
        ...
        jumpEnd.writeBack(compiler, new JumpIfNotOperator(p, begin - compiler.getProgramCounter()));
    }
}