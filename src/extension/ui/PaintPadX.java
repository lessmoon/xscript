...
public class PaintPadX extends Struct {
    ...
    public static class PadProxy{
        ...
        public Value removeString(Value id){
            return Value.valueOf(imp.removeString(id.valueAs(Integer.class)));
        }
        ...
        @StructMethod(param = {"int"}, ret = "bool")
        public Value removeCircle(Value id){
            return Value.valueOf(imp.removeCircle(id.valueAs(Integer.class)));
        }
        ...
        @StructMethod(param = {"int"}, ret = "bool")
        public Value removeLine(Value id){
            return Value.valueOf(imp.removeLine(id.valueAs(Integer.class)));
        }
        ...
        @StructMethod(param = {"int"}, ret = "bool")
        public Value removePoint(Value id){
            return Value.valueOf(imp.removePoint(id.valueAs(Integer.class)));
        }
