...
public class PaintPadX extends Struct {
    ...
    public static class PadProxy{
        ...
        static void init(final Constant arg0,Constant name, Constant width, Constant height, Position onClick,Position onMouseClick,Position onClose){
    ...
    public symbols.Struct setup(Token sname, Dictionary dic, TypeTable typeTable) {
        ...
        s.defineInitialFunction(new InitialFunction(Word.This,new Stmt(){
            ...
            @Override
            public void run(){
                PadProxy.init(arg0.getValue(),arg1.getValue(),arg2.getValue(),arg3.getValue(),onClick,onMouseClick,onClose);
            }
        },paraList,s));
        return s;
    }
